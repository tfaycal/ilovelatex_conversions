...
\copyrightyear{}
\copyrightclause{}
\conference{IDDM-2025: 8th International Conference on Informatics Data-Driven Medicine}
\title{Accurate Breast Lesion Segmentation in MRI via YOLO-Based Localization and Deep Learning}
\author[1]{Faycal Touazi}[
orcid={},
email={f.touazi@univ-boumerdes.dz},
]
\author[1]{Djamel Gaceb}[
orcid={},
email={d.gaceb@univ-boumerdes.dz},
]
\author[1]{Tayeb Benzenati}[
orcid={},
email={t.benzenati@univ-boumerdes.dz},
]
\author[1]{Faycal Arioua}[
orcid={},
email={f.arioua@univ-boumerdes.dz},
]
\author[1]{Ibtissem Telkhoukh}[
orcid={},
email={i.telkhoukh@univ-boumerdes.dz},
]
\author[1]{Nour Elhouda Magaz}[
orcid={},
email={nh.magaz@univ-boumerdes.dz},
]
\cormark[1]
\cortext[1]{Corresponding author: Faycal Touazi}
\address[1]{LIMOSE Laboratory, Computer Science Department, University M’hamed Bougara, Independence Avenue, 35000 Boumerdes, Algeria}
\begin{abstract}
...
\end{abstract}
\begin{keywords}
Breast tumor segmentation \sep magnetic resonance imaging \sep Deep Learning \sep YOLOv11-n \sep U-Net \sep A-UNet
\end{keywords}
\maketitle
